    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10 col-xl-10 col-md-8 col-sm-6 content">
                <h2 class="mt-5" style="margin-left:10px;">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#addUser" class="btn btn-tambah" style="border: none; background-color: #6600ff; color: white; padding: 10px 15px; border-radius: 8px; font-size: 16px; cursor: pointer;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
                        <i class="fa-solid fa-circle-plus"></i> Tambah Akun Staff
                    </button>
                </h2>
